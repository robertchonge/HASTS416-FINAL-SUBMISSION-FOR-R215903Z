...
save_and_show <- function(plot, filename, width = 8, height = 5) {
  # Save the plot
  ggsave(filename, plot, width = width, height = height, dpi = 100)
  # Display in markdown
...
# Plot and save - METHOD 1: Using plot() directly
png("A1_markov_diagram.png", width = 800, height = 600)
plot(mc, 
     main = "5-State Markov Chain Diagram",
     edge.arrow.size = 0.5,
     vertex.size = 30,
...
knitr::include_graphics("A1_markov_diagram.png")
```

![](A1_markov_diagram.png)<!-- -->
...
![](RobertChongeFinale_files/figure-gfm/unnamed-chunk-14-1.png)<!-- -->
...
![](RobertChongeFinale_files/figure-gfm/unnamed-chunk-21-1.png)<!-- -->
...
![](RobertChongeFinale_files/figure-gfm/unnamed-chunk-22-1.png)<!-- -->
\#Question A2  
...
![](RobertChongeFinale_files/figure-gfm/unnamed-chunk-24-1.png)<!-- -->
...
![](RobertChongeFinale_files/figure-gfm/unnamed-chunk-31-1.png)<!-- -->
...
![](RobertChongeFinale_files/figure-gfm/unnamed-chunk-42-1.png)<!-- -->
...
![](RobertChongeFinale_files/figure-gfm/unnamed-chunk-43-1.png)<!-- -->
...
![](RobertChongeFinale_files/figure-gfm/unnamed-chunk-44-1.png)<!-- -->
...
![](RobertChongeFinale_files/figure-gfm/unnamed-chunk-45-1.png)<!-- -->
